...
int main() {
	...
	//Crea un obj que representa una txt, que almacena info de la profundidad
	DrawBuffers draw_buffers;
	//Gestiona diferentes representaciones visuales de la escena (buf color, stencil, dephtmap)
	...
	do {
		...
		//Todo lo que se renderice a partir de este momento se dibujará en la textura 
		//de profundidad asociada a shadow_map
		glClear(GL_DEPTH_BUFFER_BIT);
		glEnable(GL_CULL_FACE); glCullFace(GL_FRONT);
		//Los valores de profundidad representan las partes más lejanas visibles desde la luz
